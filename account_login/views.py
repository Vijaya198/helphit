...
class SignUpView(View):
        ...
        def get(self, request, *args, **kwargs):
            ...
            except (ReadTimeout, ConnectTimeout, ConnectionAbortedError, HTTPError, Timeout, ConnectionError, TypeError,
                    KeyError, IndexError, AttributeError, ValueError, OverflowError, ValidationError, IntegrityError,
                    InterfaceError) as e:
                print("except", e)
                context = {"exception": e}
                return render_to_response('error.html', context)
...
def increment_account_number():
    ...
    ReadTimeout, ConnectTimeout, ConnectionAbortedError, HTTPError, Timeout, ConnectionError, TypeError, KeyError,
