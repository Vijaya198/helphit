...
class user_info(models.Model):
    ...
    acc_holder_name=models.CharField(max_length=254)
    acc_holder_contact_no=models.BigIntegerField()
...
class user_address(models.Model):
    account_id = models.ForeignKey(User, db_constraint=False, db_column='account_id', on_delete=models.CASCADE)
    entity_name = models.CharField(default=None, blank=True, null=True, max_length=254)
    email = models.EmailField()
    door_street = models.CharField(default=None, blank=True, null=True, max_length=254)
    locality = models.CharField(default=None, blank=True, null=True, max_length=254)
    state = models.CharField(default=None, blank=True, null=True, max_length=254)
    ...
    gstin = models.CharField(default=None, blank=True, null=True, max_length=15)
    uin = models.CharField(default=None, blank=True, null=True, max_length=15)
    insurance_no = models.CharField(default=None, blank=True, null=True, max_length=50)
    insurance_name = models.CharField(default=None, blank=True, null=True, max_length=254)
